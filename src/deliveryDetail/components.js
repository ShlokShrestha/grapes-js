export default (editor, opts = {}) => {
  ...
  domc.addType("DELIVERY-DETAIL-COMPONENTS", {
    model: {
      defaults: {
        ...
        components: [
          {
            attributes: { class: "cmp-css-deliverydetails" },
            copyable: false,
            removable: false,
            droppable: false,
            editable: false,
                ...
                components: [
                  {
                    ...
                    editable: false,
                    draggable: false,
                    attributes: { class: "cmp-css-address-details" },
                  ...
                  {
                    type: "text",
                    attributes: { class: "cmp-css-address-button " },
                    copyable: false,
                    removable: false,
                    droppable: false,
                    editable: false,
              ...
              },
              {
                ...
                components: [
                  ...
                  },
                  {
                    ...
                    droppable: false,
                    editable: false,
                    attributes: { class: "cmp-css-delivery-priority" },
                    components: [
                      {
                        tagname: "div",
                        draggable: false,
                        ...
                        droppable: false,
                        editable: false,
                        attributes: { class: "cmp-css-delivery-left" },
                        components: [
                          {
                            copyable: false,
                            removable: false,
                            ...
                            draggable: false,
                            attributes: { class: "cmp-css-address-icon" },
                            content: `<<svg width="24" height="22" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M16 0.7C15 0.7 14.2 1.5 14.2 2.5C14.2 3.5 15 4.3 16 4.3C17 4.3 17.8 3.5 17.8 2.5C17.8 1.5 17 0.7 16 0.7ZM12.4 3.6C11.93 3.6 11.5 3.79 11.2 4.1L7.5 7.79C7.19 8.1 7 8.5 7 9C7 9.63 7.33 10.16 7.85 10.47L11.2 12.5V17.5H13V11L10.75 9.35L13.07 7L14.8 9.5H19V7.7H15.8L13.86 4.43C13.57 3.93 13 3.6 12.4 3.6ZM10 2.5H3C2.45 2.5 2 2.05 2 1.5C2 0.95 2.45 0.5 3 0.5H12.79C12.58 0.84 12.41 1.21 12.32 1.61C11.46 1.63 10.65 1.95 10 2.5ZM5 11.5C2.24 11.5 0 13.74 0 16.5C0 19.26 2.24 21.5 5 21.5C7.76 21.5 10 19.26 10 16.5C10 13.74 7.76 11.5 5 11.5ZM5 20C3.07 20 1.5 18.43 1.5 16.5C1.5 14.57 3.07 13 5 13C6.93 13 8.5 14.57 8.5 16.5C8.5 18.43 6.93 20 5 20ZM19 11.5C16.24 11.5 14 13.74 14 16.5C14 19.26 16.24 21.5 19 21.5C21.76 21.5 24 19.26 24 16.5C24 13.74 21.76 11.5 19 11.5ZM19 20C17.07 20 15.5 18.43 15.5 16.5C15.5 14.57 17.07 13 19 13C20.93 13 22.5 14.57 22.5 16.5C22.5 18.43 20.93 20 19 20ZM5.32 10.5H1C0.448 10.5 0 10.05 0 9.5C0 8.95 0.448 8.5 1 8.5H5.05C5.03 8.66 5 8.83 5 9C5 9.53 5.12 10.04 5.32 10.5ZM6 6.5H2C1.45 6.5 1 6.05 1 5.5C1 4.95 1.45 4.5 2 4.5H7.97L6.09 6.37C6.05 6.41 6 6.46 6 6.5Z" fill="#4A4A4A"/>
                        </svg>
                        `,
                          },
                          {
                            ...
                            components: [
                              ...
                              },
                              {
                                ...
                                editable: false,
                                draggable: false,
                                content: "10-15 min - Delivery directly to you",
                              },
                            ],
                          },
                        ],
                      ...
                      {
                        type: "text",
                        attributes: { class: "cmp-css-address-price" },
                        copyable: false,
                        removable: false,
                        droppable: false,
                        editable: false,
        ...
        .cmp-css-address-details , .cmp-css-delivery-left{
          display: flex;
          gap: 5px
        }
